            ...
            <div class="col-lg-7">
                ...
                <div class="row">
                    <div class="col col-lg-4">
                        <a class="btn btn-white me-1" href="{{route('forum')}}">Go to forum</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="feature-card p-3 py-sm-4 rounded d-flex">
                        ...
                        <div class="flex-grow-1 ms-2">
                            <div class="content">
                                ...
                                <p class="text-muted">Get sessions with qualified professionals. First session is free. </p> <a href="{{route('specialists')}}" class="text-dark">Read More <i class="mdi mdi-chevron-right"></i></a> </div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-7 mt-sm-4">
                <div class="feature-card p-3 py-sm-4 rounded"> <i class="mdi mdi-layers-triple-outline text-primary float-start me-3 h2"></i>
                    <div class="content d-block overflow-hidden">
                        ...
                        <p class="text-muted mt-2">Know more about how to deal with your problems. </p> <a href="{{route('news')}}l" class="text-dark">Read More <i class="mdi mdi-chevron-right"></i></a> </div>
                </div>
            </div>
            <!-- end col -->
            <div class="col-lg-4 col-md-7 mt-sm-4">
                <div data-aos="fade-left" data-aos-duration="1800">
                    <div class="feature-card p-3 py-sm-4 rounded"> <i class="mdi mdi-clipboard-flow-outline text-primary float-start me-3 h2"></i>
                        <div class="content d-block overflow-hidden">
                            ...
                            <p class="text-muted mt-2">Place where you can ask your question, share with your experience and know other’s stories who had gone through it.</p> <a href="{{route('forum')}}" class="text-dark">Read More <i class="mdi mdi-chevron-right"></i></a> </div>
                    </div>
                </div>
            </div>
            <!-- end col -->
