                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    @guest('doctor')
                        @if (Route::has('doctor.login'))
                            <button class="btn btn-primary  nav-btn me-md-2"><a href="{{ route('doctor.login') }}">Log in</a>
                            </button>
                        @endif
                        @if (Route::has('doctor.register'))
                            <button class="btn btn-outline-primary nav-btn"><a
                                    href="{{ route('doctor.register') }}">Register</a></button>
                        @endif
                    @else
                        <div class="row">
                            <div class="col">
                                <div class="btn-group">
                                    <div class="profile">
                                        <button type="button" class="btn btn-primary  nav-btn me-md-2">
                                            <span id="name" class="my-auto link-white">{{ doctor()->name }}</span>
                                        </button>
